							...
							<div class="inner">
                                                            ...
                                                            <ul class="features">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <img src="<?php echo $val->imagine;?>" width="300"/>
                                                                    <br/><br/><h4><?php echo $val->pret;?></h4>
                                                                    <p><?php echo $val->ingrediente;?>
                                                                        <br/><?php echo $val->gramaj;?></p>
                                                                    <div class="button primary">
                                                                        <?php echo "<a href=\"view.php?id=".$val->_id."\">Vezi detalii</a>"?><br/>
                                                                    </div>
                                                                    <!--<a href="\<?php "view.php?id=".$val->_id."\">" ?>" class="button primary">Vezi detalii</a>-->
                                                                    </div>
                                                                </li>
                                                                <?php endif;?>
                                                                <?php endforeach;?>
