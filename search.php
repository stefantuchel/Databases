...
// create a text index on the "nume" field
$command = new MongoDB\Driver\Command([
    'createIndexes' => 'restaurant2.restaurant',
    'indexes' => [
        [
            'key' => [
                'nume' => 'text'
...
$client->executeCommand('restaurant2', $command);

// search using fuzzy search with the created text index
$filter = [
    '$text' => [
        '$search' => $nume,
        '$caseSensitive' => false,
    ...
    <li>
        <div class="align-center">
            ...
            <div class="button primary">
                <?php echo "<a href=\"view.php?id=" . $doc->_id . "\">Vezi detalii</a>" ?><br />
            </div>
        </div>
    </li>
<?php } else {
    echo 'No results. Please try again!';
                                                    ...
                                                    <div class="align-center"><a href="meniu.php" class="button primary align-center">Inapoi la meniu</a></div>
                                                </section>
                                        </article>
