...
if (isset($_POST['cauta'])) {
    $search_term = mysqli_real_escape_string($con, $_POST['cauta1']);
    $sql .= "WHERE nume_prod LIKE '%{$search_term}%' ";
    $sql .= "OR descriere LIKE '%{$search_term}%' ";
}
    ...
    <body>
            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="list-group">
                        <a class="list-group-item" href="index1.php"><img src="assets/guitar-c.svg" width="40px">  Chitari clasice</a>
                        <a class="list-group-item" href="index2.php"><img src="assets/guitar-e.svg" width="40px">  Chitari electrice</a>
                        <a class="list-group-item" href="index3.php"><img src="assets/guitar-b.svg" width="40px">  Chitari bass</a>
                    </div>
                </div>
                <div class="col-lg-9">      
        <div class="row">
     ...
     <?php } ?> 
        ...
        <footer class="py-5 bg-dark">
            ...
            <div class="container" style="text-align: center"><div class="fb-like" data-href="" data-width="" data-layout="standard" data-action="like" data-size="small" data-share="true"></div></div><br>
