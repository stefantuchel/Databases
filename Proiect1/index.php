            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="list-group">
                        <a class="list-group-item" href="index1.php"><img src="assets/guitar-c.svg" width="50px">  Chitari clasice: <?php echo $m; ?></a>
                        <a class="list-group-item" href="index2.php"><img src="assets/guitar-e.svg" width="50px">  Chitari electrice: <?php echo $f; ?></a>
                        <a class="list-group-item" href="index3.php"><img src="assets/guitar-b.svg" width="50px">  Chitari bass: <?php echo $c; ?></a>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="carousel slide my-4" id="carouselExampleIndicators" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"><img class="d-block img-fluid" src="assets/poza1.jpg" alt="First slide" /></div>
                            <div class="carousel-item"><img class="d-block img-fluid" src="assets/poza2.jpg" alt="Second slide" /></div>
                            <div class="carousel-item"><img class="d-block img-fluid" src="assets/poza3.jpg" alt="Third slide" /></div>
                        </div>
